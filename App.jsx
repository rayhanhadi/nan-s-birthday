...
import heroImg from "./assets/pics/nanda2.jpg";
    ...
    <main>
      ...
      >
        ...
        <div className="w-full max-w-screen-2xl px-5 lg:px-10 mb-[5%] flex flex-col gap-3 lg:gap-5 z-10 text-white ">
          ...
          >
           This is how Ray, someone who admires you deeply, expresses his admiration.From close by, he’s watched your light grow brighter, feeling grateful to witness all the amazing things you bring into the world. He hopes that you see how much you inspire those around you, including him.So today, with a heart full of admiration, this is how Ray says happy birthday to you.
          </p>
      ...
      <Modal setOpenModal={setOpenModal} openModal={openModal}>
        ...
        <div className="flex flex-col gap-3 lg:gap-5 p-5 text-white">
          <h1 className="font-bold text-2xl">Happy Birthday,Nandaa  </h1>
          <p>Hi Nan...</p>
          <p>
          You may not realize how much you’ve inspired me, but from the moments we’ve shared, I’ve been moved by your journey, your energy, and the way you light up the lives around you.

          </p>
          <p>On this special day, I just wanted to send a simple wish: May your path continue to be as beautiful as the person you are, and may this year bring even more joy, love, and success into your life. I pray that you win in your life, achieve your dreams, and I really wanna see you on the top, and become the person you want too. wkwkw </p>
          <p>
            Your biggest fan ,
            <br />
            Ray
